  ...
  return (
    <header className="bg-[#1b2d92]">
      ...
      >
        ...
        <div className="flex lg:flex-1 mr-[17%] sm:mr-[24%] lg:mr-0 md:mr-[32%] sm:text-xs">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">Artistic Milliners</span>
            {/* <img className="h-9 w-auto bg-white" src="/artistic_logo_crop.png" alt="" /> */}
          </a>
          <div className="text-white lg:hidden w-auto font-semibold text-base sm:text-2xl max">
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 left-0 z-10 w-3/5 overflow-y-auto bg-[#1b2d92] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
