  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-8">
      <h1 className="text-3xl font-semibold text-gray-800 mb-6 text-center md:text-left">
        Machine Details: {machineData.machine_name}
      </h1>
      ...
      <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-4">
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="font-medium text-gray-600">
            <strong>Shed:</strong> {machineData.shed}
          </p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="font-medium text-gray-600">
            <strong>Category:</strong> {machineData.category}
          </p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="font-medium text-gray-600">
            <strong>Current (Amperes):</strong> {machineData.current_amperes}
          </p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="font-medium text-gray-600">
            <strong>Frequency (Hz):</strong> {machineData.frequency}
          </p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="font-medium text-gray-600">
            <strong>Energy Consumption (kWh):</strong> {machineData.kwh}
          </p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="font-medium text-gray-600">
            <strong>Power Factor:</strong> {machineData.power_factor}
          </p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="font-medium text-gray-600">
            <strong>Power (kW):</strong> {machineData.power}
          </p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="font-medium text-gray-600">
            <strong>Voltage (V):</strong> {machineData.voltage}
          </p>
        </div>
