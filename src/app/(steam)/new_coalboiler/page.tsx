...
export interface SteamData {
  id: number;
  new_cb_steamflow: number;
  new_cb_steampressure: number;
  new_cb_waterflow: number;
}
                ...
                {data.map((item) => {
                  return (
                    <div key={item.id} className="text-sm">
                      <p>Steam Flow {item.new_cb_steamflow} T/H</p>
                      <p>Steam Pressure {(item.new_cb_steampressure).toFixed(1)} PSI</p>
                      <p>Water Flow {item.new_cb_waterflow} M3/H</p>
                    </div>
                  );
                })}
